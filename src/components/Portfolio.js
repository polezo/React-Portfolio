...
<p>NumberCommander is an math game that I'm currently developing for web using the HTML5 canvas and THREE.js. Inspired by old Apple II games like Number Munchers and Math Blasters, NumberCommander has 3 fun and simple math gamemodes with a unique space theme that kids are sure to love.<a href="https://atfmakes.com/numbercommander">Try the alpha out now!</a></p>
                </div>
...
<p>In this demo I created for AARP's Staying Sharp The user goes through a Memory Palace exercise (also known as <a href="https://en.wikipedia.org/wiki/Method_of_loci">the Method of Loci</a>) in Augmented reality. I designed and built this prototype from the ground up for Android Devices using Unity, C#, and the ARCore toolkit.</p>
                ...
                <div className="five columns modal-video">
                <a href="https://medium.com/@atyreefinch/metaverse-on-demand-using-googles-poly-api-ar-js-to-search-render-models-instantly-in-ar-e95b5145ed9e"><img width="100%" src="https://atfmakes.com/img/MetaVerseARSplash.jpg" alt="MetaverseOnDemand"></img></a>
                </div>
