...
export default class Porfolio extends Component {
  ...
  {/* reconfigure modals to work with the resume jsondata and a .map */}
      <div id="modal-1" className="modal-center mfp-hide row">
                ...
                <a href="https://atfmakes.com/reacttowork/" target="_blank"><img width="100%" src="https://atfmakes.com/img/ReactToWorkSplash2.jpg" alt="ReactToWork"></img></a>
                </div>
                <h3 className="video-text">ReactToWork <span className="modal-links"> • <a href="https://atfmakes.com/reacttowork/" target="_blank">demo</a> • <a href="https://github.com/polezo/ReactToWorkFrontend" target="_blank">github</a> </span></h3>
                
<p>A Job Board for React Engineers, built in React with a Ruby on Rails backend. This is an app I built with my friend<a href="https://www.linkedin.com/in/chungcha/" target="_blank"> Charlie Chung</a> because we saw a need for a React centric job board that was both well-populated with jobs and made jobs easy to save for later application. We designed and developed the app from the ground up. Try it out for yourself <a href="https://atfmakes.com/reacttowork/" target="_blank">here.</a></p>
...
<div id="modal-2" className="modal-center mfp-hide row">
                <div className="five columns modal-video">
                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/qxlLTEEbWWc" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen="allowfullscreen"></iframe>
                </div>
                <h3 className="video-text">BrewQueue<span className="modal-links"> • <a href="https://github.com/polezo/NumberCommander">github</a></span></h3>
                <p>I built this as a part of Flatiron School with my friend <a href="https://sergioaperez.com/" target="_blank">Sergio Perez</a> (who narrates this video). It was an experiment to see how robust a site we could make without JS. We tapped the OpenBreweryDB API for breweries around the country for users to visit and rate. Designed from scratch and styled using Bootstrap and custom CSS, users can save their favorite breweries, meet beer fans who share their tastes and more.</p> 
                </div>
                ...
                <h3 className="video-text">NumberCommander <span className="modal-links"> • <a href="https://atfmakes.com/numbercommander/" target="_blank">demo</a>  • <a href="https://github.com/polezo/NumberCommander" target="_blank">github</a> </span></h3>
                
<p>NumberCommander is an math game that I'm currently developing for web using the HTML5 canvas and THREE.js. Inspired by old Apple II games like Number Munchers and Math Blasters, NumberCommander has three fun and simple math gamemodes with a unique space theme that kids are sure to love.<a href="https://atfmakes.com/numbercommander" target="_blank"> Try the alpha out now!</a></p><br></br>
                </div>

                <div id="modal-4" className="modal-center mfp-hide row">
                <div className="five columns modal-video">
                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/Gn44gYu5uIg" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen="allowfullscreen"></iframe>
                </div>
                <h3 className="video-text">Memory Palace AR for AARP</h3>
                
<p>In this demo I created for AARP's Staying Sharp The user goes through a Memory Palace exercise (also known as <a href="https://en.wikipedia.org/wiki/Method_of_loci" target="_blank">the Method of Loci</a>) in Augmented reality. I designed and built this prototype from the ground up for Android Devices using Unity, C#, and the ARCore toolkit.</p>
                </div>

               
                <div id="modal-5" className="modal-center mfp-hide row">
                <div className="five columns modal-video">
                <a href="https://medium.com/@atyreefinch/metaverse-on-demand-using-googles-poly-api-ar-js-to-search-render-models-instantly-in-ar-e95b5145ed9e" target="_blank"><img width="100%" src="https://atfmakes.com/img/MetaVerseARSplash.jpg" alt="MetaverseOnDemand"></img></a>
                </div>
                <h3 className="video-text">MetaverseOnDemand<span className="modal-links"> • <a href="https://medium.com/@atyreefinch/metaverse-on-demand-using-googles-poly-api-ar-js-to-search-render-models-instantly-in-ar-e95b5145ed9e" target="_blank">blog</a>  • <a href="https://github.com/polezo/ARVerseOnDemand" target="_blank">github</a> </span></h3>
...
<p>JetShare is the fastest and simplest way to privately share content with Friends, Family and work colleagues. I produced, edited and animated this explainer video for the app in 2017, working with the client to deliever a script that hit all the key app benefits in a fun and engaging way.</p>
                ...
                <div className="five columns modal-video">
                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/ZFX21siT8DI" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen="allowfullscreen"></iframe>
                </div>
                <h3 className="video-text">Blue Demon AR Mask<span className="modal-links">  </span></h3>
                
<p>(<strong>Warning:</strong> Video may be scary!) This is an interactive AR mask I made for Instagram for Halloween using the Spark AR Toolkit from Facebook and scripts written in Javascript. You can read more about how it was made in <a href="https://medium.com/@atyreefinch/making-an-instagram-fb-ar-halloween-mask-with-spark-ar-studio-and-javascript-218226942a81" target="_blank"> my blog about it</a>, see a kewt video of my daughter using it <a href="https://youtu.be/jvUEV-uOSAk" target="_blank"> here</a>, or try it out in Instagram yourself using <a href="https://www.instagram.com/a/r/?effect_id=2999623446731766&ch=YTYyMTliODY1NTdhMzAzNjUwOGMyYTJhYzg0NmJhMjc="> this link</a> from a mobile device.</p>
                </div>

                <div id="modal-9" className="modal-center mfp-hide row">
                <div className="five columns modal-video">
                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/a-jrQVU9CGY" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen="allowfullscreen"></iframe>
                </div>
...
<div id="modal-10" className="modal-center mfp-hide row">
                <div className="five columns modal-video">
                <a href="https://www.cdc.gov/flu/resource-center/freeresources/graphics/animated-images.htm" target="_blank"><img width="100%" src="https://atfmakes.com/img/CDC-NIVWSplash.gif" alt="MetaverseOnDemand"></img></a>
                </div>
                <h3 className="video-text">MetaverseOnDemand<span className="modal-links"> • <a href="https://www.cdc.gov/flu/resource-center/freeresources/graphics/animated-images.htm" target="_blank">link</a></span></h3>
                
<p>This series of GIFS is a Hermes Award winning campaign I developed for the CDC while I was at Westat. These animated infographics were created as evergreen material to use every flu season and encourage key audiences to get their vaccine. I wrote and animated the gifs and used them in social and paid display marketing campaigns we ran for the client. See the collection <a href="https://www.cdc.gov/flu/resource-center/freeresources/graphics/animated-images.htm" target="_blank">here</a>.</p>
                </div>
                ...
                <div className="five columns modal-video">
                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/lkmJ6aKNQDQ" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen="allowfullscreen"></iframe>
                </div>
